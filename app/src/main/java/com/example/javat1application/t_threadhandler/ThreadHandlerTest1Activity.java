package com.example.javat1application.t_threadhandler;
...
///https://devyul.tistory.com/53
public class ThreadHandlerTest1Activity extends AppCompatActivity {
    TextView textView;
    ToyThread thread;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_thread_handler_test1);
        ...
        textView = findViewById(R.id.textinput_helper_text);
