...
public class ExecutorService3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_executor_service3);
        resultTextView = findViewById(R.id.resultTextView334);
